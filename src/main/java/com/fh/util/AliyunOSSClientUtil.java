...
public static void deleteFile(OSSClient ossClient, String bucketName, String folder, String key){
    String replace = key.replace(OSSClientConstants.BUCKET, "");
    ossClient.deleteObject(bucketName, folder + replace);
logger.info("删除" + bucketName + "下的文件" + folder + replace + "成功");
}
...
metadata.setContentDisposition("filename=" + fileName + "/" + "Byte.");
//上传文件 (上传文件流的形式)
...
return "https://sakurayue.oss-cn-beijing.aliyuncs.com/images/" + fileName;
}
